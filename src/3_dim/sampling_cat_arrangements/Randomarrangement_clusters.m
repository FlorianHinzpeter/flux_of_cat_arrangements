function x = Randomarrangement_clusters(r0,rE,N)
%---------------------------------------------------------------------------------------------
...
% generating uniform distribution of points in circle
...
x_cluster = (1-r0)*r^(1/3)*cos(phi)*sin(theta);
y_cluster = (1-r0)*r^(1/3)*sin(phi)*sin(theta);
z_cluster = (1-r0)*r^(1/3)*cos(theta);

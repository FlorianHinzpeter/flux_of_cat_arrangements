function J = Flux_bd_loss(N1,N2,x1,y1,z1,x2,y2,z2,rE,alpha1,alpha2)
...
model.physics('c2').feature.create('dir1', 'DirichletBoundary', 2);
model.physics('c2').feature('dir1').selection.named('geom1_csel1_bnd');
model.physics('c2').feature.create('flux1', 'FluxBoundary', 2);
model.physics('c2').feature('flux1').selection.named('geom1_csel2_bnd');
model.physics('c2').feature.create('flux2', 'FluxBoundary', 2);
...
model.mesh('mesh1').feature('size').set('hmax', '0.6');

function J = ClusterFlux(number,trials,N1,N2,load_arrang_path,flux_save_path)
%---------------------------------------------------------------------------------------------
...
Alpha = [0.1 1 10 100 1000];
 ...
 for i = 1:trials
     ...
     J(i,2*j-1:2*j) = Flux_bd_loss(N1,N2,X(3*i-2,1:2:(N1+N2)),X(3*i-1,1:2:(N1+N2)),X(3*i,1:2:(N1+N2)),X(3*i-2,2:2:(N1+N2)),X(3*i-1,2:2:(N1+N2)),X(3*i,2:2:(N1+N2)),0.01,Alpha(j),Alpha(j));

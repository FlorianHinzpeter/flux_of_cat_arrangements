function f = Flux_active_site(N1,N2,x1,y1,x2,y2,orientation,patch,rE,alpha1,alpha2)
%---------------------------------------------------------------------------------------------

%This function computes the fluxes for the arrangements with N1 first and N2 second catalysts with active sites
%orientation specifies the orientations of the active sites, patch is the fraction of the circumference that
%is reactive
...
model.param.set(sprintf('orientation%i',i), orientation(i), 'orientation of patch');
...
model.param.set('patch', patch, 'patch size');
...
model.geom('geom1').selection('csel4').name('Enzyme');
...
model.geom('geom1').feature(sprintf('c%i',j)).set('contributeto', 'csel4');
...
model.geom('geom1').feature(sprintf('c%i',j)).set('r', 'rE');    
model.geom('geom1').feature(sprintf('c%i',j)).set('pos', {sprintf('x2%i',(j-N1)) sprintf('y2%i',(j-N1))});
model.geom('geom1').feature(sprintf('c%i',j)).set('contributeto', 'csel4');
model.geom('geom1').feature(sprintf('c%i',j)).set('createselection', 'on');
...
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('r', 'rE');
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('angle', '2*pi*patch');
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('pos', {sprintf('x1%i',l) sprintf('y1%i',l)});
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('rot', sprintf('orientation%i',l));
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('contributeto', 'csel2');
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('createselection', 'on');
...
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('r', 'rE');
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('angle', '2*pi*patch');
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('pos', {sprintf('x2%i',(l-N1)) sprintf('y2%i',(l-N1))});
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('rot', sprintf('orientation%i',l));
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('contributeto', 'csel1');
model.geom('geom1').feature(sprintf('c%i',(l+N1+N2+1))).set('createselection', 'on');
    
end


model.geom('geom1').feature('dif4').selection('input2').named('csel1');
model.geom('geom1').feature('dif4').selection('input').named('csel3');
model.geom('geom1').feature('dif2').selection('input').named('csel3');
model.geom('geom1').feature('dif2').selection('input2').named('csel4');
model.geom('geom1').feature('dif3').selection('input2').named('csel2');
model.geom('geom1').feature('dif3').selection('input').named('csel3');
...
model.physics('c').feature('flux2').selection.named('geom1_csel1_bnd');
...
model.physics('c').feature('flux1').set('g', 'alpha1*s');
model.physics('c').feature('flux2').set('q', 'alpha2');
...
model.physics('c2').feature('flux1').set('q', 'alpha1');
...
model.result.numerical('int1').set('descr', 'u*alpha2');
model.result.numerical('int1').set('expr', 'u*alpha2');
model.result.numerical('int2').set('descr', 's*alpha1');
model.result.numerical('int2').set('expr', 's*alpha1');
model.result.numerical('int1').setResult;
model.result.numerical('int2').setResult;
f(1)=model.result.numerical('int2').getReal;
f(2)=model.result.numerical('int1').getReal;
end

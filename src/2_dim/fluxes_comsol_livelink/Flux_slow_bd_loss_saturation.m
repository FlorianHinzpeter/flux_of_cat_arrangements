...
model.physics('c').feature.create('flux3', 'FluxBoundary', 1);
model.physics('c').feature('flux3').selection.named('geom1_csel3_bnd');
...
model.physics('c').feature('flux3').set('q', 'beta2');
